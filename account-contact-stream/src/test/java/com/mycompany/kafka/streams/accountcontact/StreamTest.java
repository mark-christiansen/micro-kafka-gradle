...
public class StreamTest extends TopologyTest {
    ...
    private AccountContactTopologyBuilder accountContactTopologyBuilder;
    ...
    public void setup() {
        ...
        accountContactTopologyBuilder = new AccountContactTopologyBuilder(config, errorHandler, schemaRegistryClient, null);
    }
    ...
    public void test() throws IOException {
        ...
        Topology topology = accountContactTopologyBuilder.build(kafkaConfig);
